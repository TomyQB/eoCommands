...
public class PendingOrderController {
    ...
    public List<PendingOrderDTO> getPendingOrder(@RequestBody long restaurantId) {
        ...
        List<PendingOrderPlate> pendingOrdersPlate = pendingOrderPlateService
                .getPendingOrderByRestaurantId(restaurantId);
        List<PendingOrderAdditional> pendingOrderAdditionals = pendingOrderAdditionalService
                .getPendingOrderByRestaurantId(restaurantId);
    ...
    public List<PendingOrderDTO> deletePendingOrder(@RequestBody PedidoDTO dto) {
        List<PendingOrderPlate> pendingOrdersPlate = pendingOrderPlateService.deletePendingOrder(dto.getRestaurantId(),
                dto.getNumTable());
        List<PendingOrderAdditional> pendingOrderAdditionals = pendingOrderAdditionalService
                .deletePendingOrder(dto.getRestaurantId(), dto.getNumTable());

        return mergeTwoPendingOrderList(pendingOrdersPlate, pendingOrderAdditionals);
    }

    private List<PendingOrderDTO> mergeTwoPendingOrderList(List<PendingOrderPlate> pendingOrdersPlate,
            List<PendingOrderAdditional> pendingOrderAdditionals) {
        ...
        List<PendingOrderDTO> pendingOrderAdditionalDTOs = pendingOrderAdditionalConverter
                .toDTO(pendingOrderAdditionals);
    ...
    public List<OrdersRecordDTO> getOrderRecord(@RequestBody long restaurantId) {
        ...
        List<OrdersRecordPlate> ordersRecordPlates = ordersRecordPlateService
                .getAllOrdersRecordByRestaurantId(restaurantId);
        List<OrdersRecordAdditional> ordersRecordAdditionals = ordersRecordAdditionalService
                .getAllOrdersRecordByRestaurantId(restaurantId);
    ...
    private List<OrdersRecordDTO> mergeTwoOrderRecordList(List<OrdersRecordPlate> ordersRecordPlate,
            List<OrdersRecordAdditional> ordersRecordAdditionals) {
        ...
        List<OrdersRecordDTO> ordersRecordAdditionalDTOs = ordersRecordAdditionalConverter
                .toDTO(ordersRecordAdditionals);
